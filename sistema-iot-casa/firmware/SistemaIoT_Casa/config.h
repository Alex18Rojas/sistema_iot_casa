...
#define MQTT_BROKER     "ghjuiyuihjkhklhjkhkjnnd96c6b95c2.s1.eu.hivemq.cloud"   // Hostname del cluster HiveMQ
#define MQTT_USER       "esp8266_casa"                                          // Usuario MQTT creado en Access Management
#define MQTT_PASSWORD   "*#AIot2026*#_"                                        // Contraseña asociada al usuario
